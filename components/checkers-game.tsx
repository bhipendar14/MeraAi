...
export function CheckersGame({ mode = "duo", players = [], onClose }: CheckersGameProps) {
  return (
    <Card className="border-border/60 bg-card/60 backdrop-blur">
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        <CardTitle className="text-base">Checkers - {mode === "solo" ? "vs AI" : "Multiplayer"}</CardTitle>
      ...
      <CardContent className="space-y-4">
        <div className="bg-muted/30 p-4 rounded-md border border-border/60">
          <p className="text-sm text-muted-foreground mb-3">Checkers Board</p>
